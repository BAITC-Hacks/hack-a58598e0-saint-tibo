...
const en = {
  ...
  refreshHelp: "Updates every 30 seconds while the app is visible. Deadlines use each meeting’s time zone.",
  upcoming: "Due today or tomorrow",
  overdue: "Overdue",
  empty: "No reminders",
  emptyHelp: "There are no reviewed, unfinished actions due today, tomorrow, or earlier in your meetings.",
...
const ru: Record<keyof typeof en, string> = {
  ...
  refreshHelp: "Обновление каждые 30 секунд, пока приложение видно на экране. Сроки определяются в часовом поясе каждой встречи.",
  upcoming: "Срок сегодня или завтра",
  overdue: "Просрочено",
  empty: "Напоминаний нет",
  emptyHelp: "В ваших встречах нет проверенных незавершённых поручений со сроком сегодня, завтра или ранее.",
  emptyPage: "На этой странице нет записей. Вернитесь на предыдущую страницу.",
  loading: "Загрузка напоминаний…",
  error: "Не удалось обновить напоминания. Повторите загрузку, чтобы увидеть актуальные сроки.",
  signedOut: "Войдите, чтобы увидеть напоминания по встречам, которыми вы владеете.",
...
const kk: Record<keyof typeof en, string> = {
  ...
  refreshHelp: "Қолданба экранда көрініп тұрғанда әр 30 секунд сайын жаңартылады. Мерзімдер әр кездесудің уақыт белдеуімен анықталады.",
  upcoming: "Мерзімі бүгін немесе ертең",
  overdue: "Мерзімі өтті",
  empty: "Еске салулар жоқ",
  emptyHelp: "Кездесулеріңізде мерзімі бүгін, ертең немесе бұрын болған тексерілген, аяқталмаған тапсырмалар жоқ.",
  emptyPage: "Бұл бетте жазбалар жоқ. Алдыңғы бетке оралыңыз.",
  loading: "Еске салулар жүктелуде…",
  error: "Еске салуларды жаңарту мүмкін болмады. Өзекті мерзімдерді көру үшін қайта жүктеңіз.",
  signedOut: "Өзіңіз иелік ететін кездесулердің еске салуларын көру үшін кіріңіз.",
