...
class ProcessingJobCreate(BaseModel):
    ...
    target_stage: Literal["transcribe", "diarize"] = Field(
        default="transcribe", description="Diarize also produces anonymous speaker intervals."
    )
...
class ProcessingJobRead(ReadModel):
    ...
    target_stage: Literal["transcribe", "diarize"]
    attempt: int
