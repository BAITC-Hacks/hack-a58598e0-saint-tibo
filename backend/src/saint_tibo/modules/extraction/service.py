...
from saint_tibo.modules.results.schemas import ReviewRead, ReviewSummary, ReviewUpdate
...
async def extract_existing(
    ...
    if version.revision != 1 or version.extraction_draft is not None:
    ...
    if review.action_items or review.summary != ReviewSummary():
        raise APIError(409, "extraction_already_exists", "Review content already exists")
    segments = list(
