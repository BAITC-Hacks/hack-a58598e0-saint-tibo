...
**Готовы основа и API хранения записей:** вход и регистрация, проверка сессий и прав,
рабочее пространство RU/KK/EN, PostgreSQL с миграциями, типизированный
API-клиент и сборка. API поддерживает совещания и участников, загрузку файла или
частей, защищённое воспроизведение с перемоткой и удаление. Пользовательские экраны
этого сценария, STT, диаризация, извлечение поручений и экспорт ещё не реализованы.
